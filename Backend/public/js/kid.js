...
const kidProductList = document.getElementById('kid-product-list')
const kidProduct = products.filter(product=>product.category === 'kid');
let cart = JSON.parse(localStorage.getItem("cart")) || [];
if (kidProduct.length === 0) {
  kidProductList.innerHTML='<p>No product found in this category</p>'
}else{
  kidProduct.forEach(product=>{
    ...
    `
    kidProductList.appendChild(productItem)
  })
